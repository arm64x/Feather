...
class LibraryViewController: UITableViewController {
    ...
    private func setupToolbar() {
        ...
        NSLayoutConstraint.activate([
            deleteToolbar.leadingAnchor.constraint(equalTo: view.leadingAnchor),
            deleteToolbar.trailingAnchor.constraint(equalTo: view.trailingAnchor),
            deleteToolbar.bottomAnchor.constraint(equalTo: view.safeAreaLayoutGuide.bottomAnchor)
        ])
        ...
        deleteToolbar.items = [flexibleSpace, deleteButton, flexibleSpace]
    ...
    @objc private func toggleEditingMode() {
        ...
        deleteToolbar.isHidden = !isEditingMode
    ...
    @objc private func deleteSelectedApps() {
        ...
        let alert = UIAlertController(
            title: "Delete Apps",
            message: "Are you sure you want to delete \(selectedApps.count) selected app(s)? This action cannot be undone.",
        ...
        alert.addAction(UIAlertAction(title: "Delete", style: .destructive) { [weak self] _ in
            ...
            let sortedIndexPaths = self.selectedApps.sorted { $0 > $1 }
            ...
            for indexPath in sortedIndexPaths {
                ...
                case 1:
                    if let downloadedApp = source as? DownloadedApps {
...
extension LibraryViewController {
    ...
    override func tableView(_ tableView: UITableView, willDisplay cell: UITableViewCell, forRowAt indexPath: IndexPath) {
        if isEditingMode {
            ...
            cell.accessoryType = selectedApps.contains(indexPath) ? .checkmark : .none
        } else {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        if isEditingMode {
            if selectedApps.contains(indexPath) {
            ...
            case 0:
                if FileManager.default.fileExists(atPath: filePath2!.path) {
                    ...
                    if let presentationController = popupVC.presentationController as? UISheetPresentationController {
                        presentationController.detents = [detent2, .medium()]
    ...
    private func updateDeleteButtonState() {
        if let deleteButton = deleteToolbar.items?[1] {
            deleteButton.isEnabled = !selectedApps.isEmpty
            deleteButton.title = selectedApps.isEmpty ? "Delete" : "Delete (\(selectedApps.count))"
        }
    }
}
...
// Placeholder functions (ensure these are defined elsewhere in your project)
func startImporting() { /* Implement or ensure this exists */ }
func startInstallProcess(meow: NSManagedObject, filePath: String) { /* Implement or ensure this exists */ }
func shareFile(meow: NSManagedObject, filePath: String) { /* Implement or ensure this exists */ }
func resignApp(certificate: Any, appPath: URL, completion: @escaping (Bool) -> Void) { /* Implement or ensure this exists */ }
func handleIPAFile(destinationURL: URL, uuid: String, dl: AppDownload) throws { /* Implement or ensure this exists */ }
