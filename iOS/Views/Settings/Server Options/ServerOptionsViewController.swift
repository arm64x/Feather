...
extension ServerOptionsViewController {
	...
	override func tableView(_ tableView: UITableView, titleForFooterInSection section: Int) -> String? {
		switch section {
		case 0: return String.localized("SETTINGS_VIEW_CONTROLLER_SECTION_CHECK_SIGNED_APP_UPDATE_DESCRIPTION")
	...
	override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
		...
		case "App Updates":
			...
			useS.textLabel?.text = String.localized("SETTINGS_VIEW_CONTROLLER_SECTION_CHECK_SIGNED_APP_UPDATE")
